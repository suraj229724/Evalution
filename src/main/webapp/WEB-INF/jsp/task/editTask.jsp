        ...
        <div class="page-container page-navigation-toggled page-container-wide">
            ...
            <div class="page-content">
                ...
                <div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form:form cssClass="form-horizontal" commandName="task" method="POST" action="../task/editTask.htm" name="form1" id="form1">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-xs-12">
                                                <select id="client.clientId" name="client.clientId" class="form-control select">
                                                    <c:forEach items="${clientList}" var="item">
                                                        <option value="${item.clientId}" <c:if test="${item.clientId==task.client.clientId}">selected</c:if>>${item.clientName}</option>
                                                    </c:forEach>
                                                </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-xs-12">
                                                <select id="shiftTime.shiftTimeId" name="shiftTime.shiftTimeId" class="form-control select">
                                                    <c:forEach items="${shiftTimeList}" var="item">
                                                        <option value="${item.shiftTimeId}" <c:if test="${item.shiftTimeId==task.shiftTime.shiftTimeId}">selected</c:if>>${item.shiftTime}</option>
                                                    </c:forEach>
                                                </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6 col-xs-12">
                                                <select id="taskType.taskTypeId" name="taskType.taskTypeId" class="form-control select">
                                                    <c:forEach items="${taskTypeList}" var="item">
                                                        <option value="${item.taskTypeId}" <c:if test="${item.taskTypeId==task.taskType.taskTypeId}">selected</c:if>>${item.taskTypeDesc}</option>
                                                    </c:forEach>
                                                </select>
